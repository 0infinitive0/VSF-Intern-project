"""Session-bound `recommend_hotels` tool factory."""
...
def build_recommend_hotels_tool(session: TripSession) -> BaseTool:
    @tool
    def recommend_hotels(
        ...
        """
        from src.agents.session import _save_pending_hotel_selection
        ...
        if not destination_id:
            return f"SYSTEM ERROR: Không tìm thấy dữ liệu điểm đến cho {clean_destination}."
