...
_HOTEL_COLUMNS = [
    ...
    "country", "location_highlight", "coordinates", "amenities", "amenity_groups",
    "highlights", "awards", "warnings", "review_score", "review_count", "review_text",
    "category_scores", "score_distribution", "check_in_time", "check_in_until",
    ...
    "price_check_in_date", "price_check_out_date", "rooms_available", "offer_count",
    "scraped_at",
]
...
# amenity_groups/category_scores/score_distribution/nearby_attractions/nearby_essentials are
# JSONB; amenities/highlights/awards/warnings/images are native Postgres TEXT[] arrays and must
# NOT be wrapped in Json(), psycopg2 adapts Python lists of str to TEXT[] directly.
_ARRAY_JSONB_EXCEPTIONS = {"amenities", "highlights", "awards", "warnings", "images", "room_facilities"}
...
def run_hotel_pipeline(
    ...
    return quality_check_hotels(validation_stats, dedupe_stats, load_stats, deduped, reports_dir)
