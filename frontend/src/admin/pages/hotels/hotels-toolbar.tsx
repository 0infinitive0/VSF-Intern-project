...
export function HotelsToolbar({
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
      ...
      <Select value={source} onChange={(e) => onSourceChange(e.target.value as SourceFilter)} style={{ width: 170 }}>
      ...
      <Select value={embedding} onChange={(e) => onEmbeddingChange(e.target.value as EmbeddingFilter)} style={{ width: 170 }}>
